...
class ActivityViewController: UIViewController {
    ...
    func setActivityData(){
        let lowActivity = Activity(id: 0, level: .low, desc: "driving, walking, office work, reading", caloriesMultiply: 1.2)
        ...
        let liveActivity = Activity(id: 3, level: .live, desc: "Based on your daily activity", caloriesMultiply: 1)
